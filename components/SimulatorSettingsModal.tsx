  ...
  const renderAnesthesiaTab = () => (
    <div className="space-y-4">
      ...
      <SubHeading>{t.anesthesiaSettings_subheading_defaultParams}</SubHeading>
       <SettingsFieldDisplay label={t.anesthesiaSettings_defaultFGFLabel} value={settings.anesthesia.defaultFGF} unit="L/min" onEdit={() => setEditingNumeric({ path:['anesthesia','defaultFGF'], title: t.anesthesiaSettings_defaultFGFLabel, unit:"L/min", min:0.2, max:15, step:0.1, allowDecimal: true, showKeypad: false})} themeColors={themeColors} />
